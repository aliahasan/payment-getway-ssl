          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <select
                name="billing-state"
                id="billing-state"
                className="mt-2 sm:mt-0 sm:ml-3 w-full sm:w-1/6 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
              >
              ...
              <input
                type="text"
                name="billing-zip"
                className="mt-2 sm:mt-0 sm:ml-3 w-full sm:w-1/6 flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                placeholder="ZIP"
              />
            </div>
